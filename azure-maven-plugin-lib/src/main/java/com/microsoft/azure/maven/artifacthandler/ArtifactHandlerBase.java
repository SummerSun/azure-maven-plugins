...
public abstract class ArtifactHandlerBase implements ArtifactHandler {
    ...
    protected String artifactFilePath;
    ...
    public abstract static class Builder<T extends Builder<T>> {
        ...
        public T linuxRuntime(final String value) {
            this.linuxRuntime = value;
            return self();
        }

        public T artifactFilePath(final String value) {
            this.artifactFilePath = value;
            return self();
        }

        public T contextPath(final String value) {
    ...
    protected ArtifactHandlerBase(Builder<?> builder) {
        ...
        this.artifactFilePath = builder.artifactFilePath;
